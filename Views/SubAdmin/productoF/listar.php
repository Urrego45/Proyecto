<div class="card w-75 p-0 my-5 mx-auto">
        <table border="1" cellspacing="5" cellpadding="5">
            <thead>
                <tr >
                    <th colspan="9"> <center> <a href="?v=crearPrS" class="btn btn-primary" value="">Nuevo Producto </a></center> </th>
                </tr>
                <tr>
                    <th>Producto</th>
                    <th>Nombre</th>
            ...
            <?php foreach($this->productof->listar() as $ac): ?>
                <tr>
                    ...
                    <td>
                        <a href="?v=editarPrS&id=<?php echo $ac->idProductoFinal; ?>" class="btn btn-block btn-danger">Editar</a>
